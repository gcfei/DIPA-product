...
public class OpenKnimeViewAction extends Action {
    ...
    public OpenKnimeViewAction(final String viewID) {
        LOGGER.debug(Messages.getString("OpenKnimeViewAction.0") + viewID //$NON-NLS-1$
                + Messages.getString("OpenKnimeViewAction.1")); //$NON-NLS-1$
        setId(viewID);
    }
    ...
    public void run() {
        try {
            ...
            LOGGER.coding(Messages.getString("OpenKnimeViewAction.2") + getId(), e); //$NON-NLS-1$
        }
    }
