...
public class KNIMEApplicationActionBarAdvisor extends ActionBarAdvisor {
    ...
    protected void makeActions(final IWorkbenchWindow window) {
        ...
        m_newAction.setText(Messages.getString("KNIMEApplicationActionBarAdvisor.0")); //$NON-NLS-1$
    ...
    protected void fillMenuBar(final IMenuManager menuBar) {
        ...
        final MenuManager fileMenu = new MenuManager(Messages.getString("KNIMEApplicationActionBarAdvisor.1"), //$NON-NLS-1$
                IWorkbenchActionConstants.M_FILE);

        MenuManager editMenu =
                new MenuManager(Messages.getString("KNIMEApplicationActionBarAdvisor.2"), IWorkbenchActionConstants.M_EDIT); //$NON-NLS-1$
        MenuManager viewMenu =
                new MenuManager(Messages.getString("KNIMEApplicationActionBarAdvisor.3"), IWorkbenchActionConstants.M_VIEW); //$NON-NLS-1$
        MenuManager helpMenu =
                new MenuManager(Messages.getString("KNIMEApplicationActionBarAdvisor.4"), IWorkbenchActionConstants.M_HELP); //$NON-NLS-1$
        ...
        fileMenu.add(new GroupMarker(Messages.getString("KNIMEApplicationActionBarAdvisor.5"))); //$NON-NLS-1$
        fileMenu.add(new Separator());
        fileMenu.add(m_changeWorkspaceAction);
        fileMenu.add(new GroupMarker(Messages.getString("KNIMEApplicationActionBarAdvisor.6"))); //$NON-NLS-1$
        fileMenu.add(new Separator());
        fileMenu.add(m_preferencesAction);
        fileMenu.add(m_exportPrefAction);
        fileMenu.add(m_importPrefAction);
        fileMenu.add(new GroupMarker(Messages.getString("KNIMEApplicationActionBarAdvisor.7"))); //$NON-NLS-1$
        fileMenu.add(new Separator());
        fileMenu.add(m_installFeaturesAction);
        fileMenu.add(m_updateKnimeAction);
        fileMenu.add(new GroupMarker(Messages.getString("KNIMEApplicationActionBarAdvisor.8"))); //$NON-NLS-1$
        fileMenu.add(new Separator());
        ...
        fileMenu.add(new GroupMarker(Messages.getString("KNIMEApplicationActionBarAdvisor.9"))); //$NON-NLS-1$
        editMenu.add(new Separator());
        editMenu.add(m_cutAction);
        editMenu.add(m_copyAction);
        editMenu.add(m_pasteAction);
        fileMenu.add(new GroupMarker(Messages.getString("KNIMEApplicationActionBarAdvisor.10"))); //$NON-NLS-1$
        editMenu.add(new Separator());
        ...
        final String[] unwanted = new String[] {
                "org.eclipse.birt.report.designer.ui.LibraryPublisAction", //$NON-NLS-1$
                "org.eclipse.birt.report.designer.ui.TemplatepublisAction"}; //$NON-NLS-1$
    ...
    protected void fillCoolBar(final ICoolBarManager coolBar) {
        ...
        coolBar.add(new ToolBarContributionItem(toolbar, Messages.getString("KNIMEApplicationActionBarAdvisor.13"))); //$NON-NLS-1$
    ...
    private List<IAction> createMultiInstanceViewActions() {
        ...
        IExtensionPoint point =
                registry.getExtensionPoint(
                        "org.knime.workbench.ui.multipleInstanceViews"); //$NON-NLS-1$
        if (point == null) {
            return result;
        }
        ...
        for (IExtension extension : ext) {
            ...
            for (IConfigurationElement c : conf) {
                String viewId = c.getAttribute("id"); //$NON-NLS-1$
    ...
    public void fillActionBars(final int flags) {
        ...
        String actionSetId = "org.eclipse.ui.actionSet.openFiles"; //$NON-NLS-1$
