...
class NightlyBuildLabel extends ContributionItem {
    public NightlyBuildLabel() {
        super("knime.nightly.label"); //$NON-NLS-1$
    }
    ...
    public void fill(final Composite parent) {
        ...
        label.setText(Messages.getString("NightlyBuildLabel.1")); //$NON-NLS-1$
        ...
        label.setToolTipText(Messages.getString("NightlyBuildLabel.2") //$NON-NLS-1$
            + Messages.getString("NightlyBuildLabel.3")); //$NON-NLS-1$
